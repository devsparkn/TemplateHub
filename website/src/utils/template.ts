...
export const templates: Template[] = [
  ...
  },
  {
    ...
    authorId: null,
    downloadUrl: "https://example.com/download/sentinel-ai-template.zip",
  },
  {
    slug: "portfolio-site",
    title: "Portfolio",
    description:
      "A clean, minimalist portfolio template for designers and developers.",
    thumbnailUrls: [
      "https://res.cloudinary.com/dyg4weoem/image/upload/v1747415249/portfolio_wwkrgs.png",
    ],
