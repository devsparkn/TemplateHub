...
export default function AdminTemplatesPage() {
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      setTemplates(
        templates.map((t) => (t._id === currentTemplate._id ? result.data : t))
      );
      ...
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="new-thumbnail" className="text-right">
                Thumbnail URL
              </Label>
              <Input
                id="new-thumbnail"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="new-previewUrl" className="text-right">
                Preview URL
              </Label>
              <Input
                id="new-previewUrl"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="new-techStack" className="text-right">
                Tech Stack
              </Label>
              <Input
                id="new-techStack"
