      ...
      <div className="container py-12 md:py-16 relative">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-10">
          <div className="text-center lg:text-left">
            <Link href="/" className="flex flex-col lg:flex-row items-center gap-2 mb-4 group">
              <div className="relative w-12 h-12 rounded-full bg-gradient-to-r from-primary-600 to-primary-400 flex items-center justify-center overflow-hidden group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="absolute inset-0 bg-white dark:bg-gray-900 transition-all duration-300 scale-0 group-hover:scale-100 rounded-full -translate-y-full group-hover:translate-y-0"></div>
                <span className="font-bold text-2xl text-primary-600 dark:text-primary-400 relative z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">P</span>
              </div>
              <span className="text-2xl font-bold text-gradient gradient-primary">
                Portfolio
              </span>
            </Link>
            <p className="text-gray-600 dark:text-gray-400 text-sm max-w-md mb-6">
              A professional portfolio showcasing my skills, projects, and experience in web development. I craft beautiful, responsive, and user-friendly digital experiences.
            </p>
            <div className="flex items-center justify-center lg:justify-start space-x-5 mb-6 lg:mb-0">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transform transition-transform hover:scale-110">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transform transition-transform hover:scale-110">
                <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 9.99 9.99 0 01-3.127 1.195 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.937 4.937 0 004.604 3.417 9.868 9.868 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.054 0 13.999-7.496 13.999-13.986 0-.209 0-.42-.015-.63a9.936 9.936 0 002.46-2.548l-.047-.02z"/>
                </svg>
                <span className="sr-only">Twitter page</span>
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transform transition-transform hover:scale-110">
                <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-6 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            © {currentYear} Portfolio. All rights reserved. Made with <span className="text-red-500">♥</span> by Nadeem 
          </p>
        </div>
      </div>
    </footer>
